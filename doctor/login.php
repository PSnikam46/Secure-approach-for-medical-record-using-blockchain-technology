        ...
        <div class="sign-in-wrapper">
            <div class="sign-container">
                <div class="text-center">
                    ...
                    <h4>Login to Doctor</h4>
                </div>

                <form class="sign-in-form" role="form" action="login_back.php" method="POST">
                    <div class="form-group">
                        <input type="email" name="d_email" class="form-control" placeholder="Email ID" required="">
                    </div>
                    <div class="form-group">
                        <input type="password" name="d_password" class="form-control" placeholder="Password" required="">
                    </div>
