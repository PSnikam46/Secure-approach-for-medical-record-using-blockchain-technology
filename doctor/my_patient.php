                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table convert-data-table table-striped">
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM `patient` WHERE p_id IN (SELECT p_id FROM treatment WHERE d_id = ".$_SESSION['d_id'].")";
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    echo "<td><a href='see_treatment.php?p_id=".$row['p_id']."'><span class='glyphicon glyphicon-th-list'></span></a></td>";
                                                    echo "</tr>";
                                                }
