    ...
    <body>
        ...
        <div id="ui" class="ui">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown dropdown-usermenu">
                            <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                <?php
                                    $p_photo = $_SESSION['p_photo'];
                                ?>
                                <div class="user-avatar"><img src="<?php echo '../uploads/patient/'.$p_photo; ?>"  alt="..."></div>
                                <span class="hidden-sm hidden-xs"><?php echo $_SESSION['p_name']; ?></span>
            ...
            <aside id="aside" class="ui-aside">
                <ul class="nav" ui-nav>
                    <li>
                        <a href="index.php"><i class="fa fa-list-alt"></i><span> My Treatment </span></a>
                        <ul class="nav nav-sub">
                            <li class="nav-sub-header"><a href="index.php"><span>My Treatment</span></a></li>
                        </ul>
                    </li>
                    <!-- <li>
